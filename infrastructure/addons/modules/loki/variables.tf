...
variable "cluster_name" {
  description = "EKS cluster name where Loki will be deployed"
  type        = string
}

variable "namespace" {
  description = "Kubernetes namespace for Loki service account"
  type        = string
}

variable "service_account" {
  description = "Kubernetes service account name for Loki pods"
  type        = string
}
